...
# %%
def problem1_1():
    return print("Problem Set 1") # replace this pass (a do-nothing) statement with your code
...
def problem1_3(n):
    ...
    for i in range(n+1):
        my_sum += i
    return my_sum # replace this pass (a do-nothing) statement with your code
...
def problem1_4(miles):
    feet = miles * 5280
    return print('There are', feet, 'feet in', miles, 'miles.')  # replace this pass (a do-nothing) statement with your code
...
def problem1_6():
    ...
    for i in range(1, 101, 2):
        odd_number.append(i)
    return print(*odd_number) # replace this pass (a do-nothing) statement with your code
...
def problem1_7():
    ...
    A = (1 / 2)*dno*h
    return print(A)  # replace this pass (a do-nothing) statement with your code
